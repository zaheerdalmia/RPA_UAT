<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ccupload.aspx.cs" Inherits="rpa_mazar.contractcreationupload" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CC Upload - RPA Dalmia</title>
...
<body>
                    ...
                    <div class="col-xl-8 order-xl-1">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">CC Excel Upload</h3>
                                    </div>
                                    <%--  <div class="col-6 text-right" style="padding-right: 0px">
                                        <a href="#!" class="btn btn-sm btn-primary" id="lnk_FormatDownload" runat="server" onserverclick="lnk_FormatDownload_ServerClick">Download Format <i class="fas fa-download mr-2" onclick="clearMessage();"></i></a>
                                    </div>--%>
                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-file">
                                    <asp:FileUpload runat="server" class="custom-file-input" name="files[]" ID="pofileupload" onchange="CheckExtension(pofileupload,'xlsx')" onclick="clearMessage();"></asp:FileUpload>
                                    <label class="custom-file-label" for="customFileLang">Select file</label>
                                </div>
                                <div style="margin-top: 25px; display: none;">
                                    <button type="button" id="btn_poupload" runat="server" onclick="javascript:this.disabled=true;" onserverclick="btn_poupload_ServerClick" class="btn btn-primary btn-lg btn-block">Upload CC Input File <i class="fas fa-upload mr-2"></i></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">CC PO Upload (PDF/JPG)</h3>
                                    </div>
                                    <%--  <div class="col-6 text-right" style="padding-right: 0px">
                                        <a href="#!" class="btn btn-sm btn-primary" id="lnk_FormatDownload" runat="server" onserverclick="lnk_FormatDownload_ServerClick">Download Format <i class="fas fa-download mr-2" onclick="clearMessage();"></i></a>
                                    </div>--%>
                            ...
                            <div class="card-body">
                                <label id="lbl_Message1" runat="server"></label>
                                <div class="custom-file">
                                    <asp:FileUpload runat="server" class="custom-file-input" name="files[]" ID="popdffileupload" onchange="CheckExtension(popdffileupload,'pdf')" onclick="clearMessage();" AllowMultiple="true"></asp:FileUpload>
                                    <label class="custom-file-label" for="customFileLang">Select file</label>
                                </div>
                                <asp:Label ID="listofuploadedfiles" runat="server" Visible="false" />
                                <div style="margin-top: 25px">
                                    <button type="button" id="btn_popdfupload" runat="server" onclick="if (!hasFilesSelected()) return false;javascript:this.disabled=true;" causesvalidation="false" onserverclick="btn_popdfupload_ServerClick" class="btn btn-primary btn-lg btn-block">Upload CC Files <i class="fas fa-upload mr-2"></i></button>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function CheckExtension(file, type) {
            var ValidFilesTypes;
            if (type == 'xlsx') {
                ValidFilesTypes = ["xls", "xlsx"];
            }
            else {
                ValidFilesTypes = ["pdf", "jpeg", "jpg"];
            }
            $('#lbl_Message').text("");
        ...
        function hasFilesSelected() {
            var popdffileupload = document.getElementById('popdffileupload');
            var pofileupload = document.getElementById('pofileupload');
            if (pofileupload.value == '' || popdffileupload.value == '') {
                var lbl_Message = document.getElementById('lbl_Message');
                lbl_Message.removeAttribute("style");
                lbl_Message.setAttribute("style", "color:red; font-weight:bold;");
                lbl_Message.innerText = "Oops! You Forgot To Select the File(s)...";
                return false;
            } else {
                return true;
            }
