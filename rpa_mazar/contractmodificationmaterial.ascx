<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contractmodificationmaterial.ascx.cs" Inherits="rpa_mazar.contractmodificationmaterial" %>
 <!-- Main content -->
                    ...
                    <div class="col-xl-12 order-xl-1">
                        <div class="card">                           
                            ...
                            <div class="col-md-12 mt-0">
                                <h3 class="mb-0">Contract Modification Material </h3>
                            ...
                            <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                                ...
                                                <Columns>
                                                   ...
                                                   <asp:BoundField DataField="ApprovalEmail" HeaderText="SPOC" />
                                                    ...
                                                    <asp:BoundField DataField="ModifiedMaterialCode" HeaderText="Modified Material Code" />
                                                    <asp:BoundField DataField="ExistingMaterialCode" HeaderText="Existing Material Code" />
                                        ...
                                        <div style="margin-top: 25px" id="dvCMMaterial" runat="server">
