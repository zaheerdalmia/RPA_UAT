...
namespace rpa_mazar
{
    public partial class CMApproveRejectAll : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!(Session["username"] == null))
            {
                try
                {
                    ...
                    string contractFlag = Convert.ToString(Request.QueryString["cflag"]);
                    ...
                    conn.Open();
                    cmd.Connection = conn;
                    cmd.CommandText = "NTContractUpd_ApproveAll_RejectAll";
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.AddWithValue("@vContractFlag", contractFlag);
                    cmd.Parameters["@vContractFlag"].Direction = ParameterDirection.Input;
