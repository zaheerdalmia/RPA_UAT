<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ntsoupload.aspx.cs" Inherits="rpa_mazar.ntsoupload" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SO Upload - RPA Dalmia</title>
                ...
                <!-- Collapse -->
                 <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav mb-md-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ntsoupload.aspx" id="mnu_non_trade_sales_upload" runat="server" visible="true">
                                <i class="ni ni-app"></i>
                    ...
                    <ul class="navbar-nav mb-md-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ntsomis.aspx" id="mnu_non_trade_so_mis" runat="server" visible="false">
                                <i class="ni ni-collection"></i>
                                <span class="nav-link-text">NT SO</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">Non Trade SO Upload</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="release">Release Type 
                                    <asp:RadioButton Text="NOD Block" runat="server" id="nod_block" style="margin-left: 20px" Checked="true" GroupName="release_type"/>
                                    <asp:RadioButton Text="Floor Price" runat="server" id="floor_price" style="margin-left: 15px" Checked="false" GroupName="release_type"/>
                                </div>
                                ...
                                <div style="margin-top: 25px">
                                    <button type="button" id="btn_upload"  runat="server" onclick="javascript:this.disabled=true;" onserverclick="btn_upload_ServerClick" class="btn btn-primary btn-lg btn-block">Upload Non Trade SO Input File <i class="fas fa-upload mr-2"></i></button>
                                </div>
