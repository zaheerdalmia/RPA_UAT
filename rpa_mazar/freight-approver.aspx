<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="freight-approver.aspx.cs" Inherits="rpa_mazar.FreightApprover" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Freight Approver View - RPA Dalmia</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">Freight Requests - Approve / Reject</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                        HeaderStyle-CssClass="thead-light" RowStyle-CssClass="list" GridLines="None" DataKeyNames="TransactionID"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SPOC" HeaderText="SPOC" />
                                            <asp:BoundField DataField="REQID" HeaderText="REQID" />
                                            <asp:BoundField DataField="RPAID" HeaderText="RPAID" />
                                            <asp:BoundField DataField="ZONE" HeaderText="ZONE" />
                                            <asp:BoundField DataField="STATEPLANT" HeaderText="STATE PLANT" />
                                            <asp:BoundField DataField="TRANSPORTATIONPLANNINGPOINT" HeaderText="TRANSPORTATION PLANNING POINT" />
                                            <asp:BoundField DataField="DISTRIBUTIONCHANNEL" HeaderText="DISTRIBUTION CHANNEL" />
                                            <asp:BoundField DataField="SHIPMENTROUTE" HeaderText="SHIPMENT ROUTE" />
                                            <asp:BoundField DataField="SHIPPINGTYPEFORSHIPMENTSTAGE" HeaderText="SHIPPING TYPE FOR SHIPMENT STAGE" />
                                            <asp:BoundField DataField="PACKAGINGMATERIALS" HeaderText="PACKAGING MATERIALS" />
                                            <asp:BoundField DataField="TODATE" HeaderText="TODATE" />
                                            <asp:BoundField DataField="FROMDATE" HeaderText="FROM DATE" />
                                            <asp:BoundField DataField="RATE" HeaderText="RATE" />
                                            <asp:BoundField DataField="SHIPINGCONDITION" HeaderText="SHIPING CONDITION" />
                                            <asp:BoundField DataField="MEANSOFTRANSTYPE" HeaderText="MEANS OF TRANS TYPE" />
                                            <asp:BoundField DataField="INCOTERMS" HeaderText="INCOTERMS" />
                                            <asp:BoundField DataField="SERVICESAGENT" HeaderText="SERVICES AGENT" />
