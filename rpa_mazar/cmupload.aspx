<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cmupload.aspx.cs" Inherits="rpa_mazar.cmupload" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CU Upload - RPA Dalmia</title>
    ...
    <link rel="stylesheet" href="assets/css/argon.css?v=1.2.0" type="text/css" />
     <script type="text/javascript">
         function MyFunction(Id) {
             PageMethods.CheckContractType(Id,onSuccess, onFailure);             
         }         
         function onSuccess(val) {
             var tot1 = val.split(',');             
             //alert(tot1[0]);   
             document.getElementById("totalrequests").innerHTML=tot1[4];
             document.getElementById("totalapproved").innerHTML=tot1[1];
             document.getElementById("totalrejected").innerHTML = tot1[2];

             document.getElementById("requestid").innerHTML = tot1[3];
             document.getElementById("requestcount").innerHTML = tot1[4];
         }
         function onFailure() { }
     </script>
</head>
<body>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-profile-stats d-flex justify-content-center">
                                                <div>
                                                    <span class="heading" id="totalrequests" runat="server">0</span>                                                   
                                                    <span class="description">Requests</span>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    <span class="heading" id="totalrejected" runat="server">0</span>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">
                                            <asp:Label ID="lblTitle" runat="server" Text="Contract Management "></asp:Label></h3>
                                    </div>
                                    <div class="col-3 text-right" style="padding-right: 0px; display:none;" id="dvDownload" >
                            ...
                            <div class="card-body">
                                <div class="custom-control custom-radio mb-0">
                                    <input type="radio" id="rd_cc" runat="server" name="customRadio" class="custom-control-input" onclick="MyFunction2();"/>
                                    <label class="custom-control-label" for="rd_cc">Contract Creation </label>
                                </div>
                                <div class="custom-control custom-radio mb-0">
                                    <input type="radio" id="rd_ce" runat="server" name="customRadio" class="custom-control-input"  onclick="clearMessage();show_cm1();show_lt1();MyFunction('E');"/>
                                    <label class="custom-control-label" for="rd_ce">Contract Extension </label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="rd_csc" runat="server" name="customRadio" class="custom-control-input" onclick="clearMessage();show_cm1();show_lt1();MyFunction('SC');" />
                                    <label class="custom-control-label" for="rd_csc">Contract Short Closer </label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="rd_cm" runat="server" name="customRadio" class="custom-control-input" onclick="clearMessage();show_cm2();show_lt1();" />
                                    <label class="custom-control-label" for="rd_cm">Contract Modification </label>

                                    <div id="show-mecm" style="display: none; padding: 10px;">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="rd_plant" runat="server" name="customRadio1" class="custom-control-input" onclick="MyFunction('P');"/>
                                            <label class="custom-control-label" for="rd_plant">Plant </label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="rd_material" runat="server" name="customRadio1" class="custom-control-input" onclick="MyFunction('M');"/>
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="rd_clt" runat="server" name="customRadio" class="custom-control-input" onclick="clearMessage();show_cm1();show_lt2();" />
                                    <label class="custom-control-label" for="rd_clt">Contract Long Term </label>

                                    <div id="show-melt" style="display: none; padding: 10px;">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="rd_master" runat="server" name="customRadio1" class="custom-control-input" onclick="MyFunction('LT');"/>
                            ...
                            <div class="card-body" id="dvUpload" style="display:none;">
                                ...
                                <div style="margin-top: 25px">
                                    <button type="button" id="btn_upload" runat="server" class="btn btn-primary btn-lg btn-block" onclick="javascript:this.disabled=true;" onserverclick="btn_upload_ServerClick">Upload CM Input File <i class="fas fa-upload mr-2"></i></button>
                                </div>
    ...
    <script type="text/javascript">
        ...
        chk1 = document.getElementById('rd_ce');
        chk2 = document.getElementById('rd_csc');
        chk3 = document.getElementById('rd_plant');
        chk4 = document.getElementById('rd_material');
        chk5 = document.getElementById('rd_master');
        chk6 = document.getElementById('rd_contactc');
