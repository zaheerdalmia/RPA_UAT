<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contractshortcloser.ascx.cs" Inherits="rpa_mazar.contractshortcloser" %>
                    ...
                    <div class="col-xl-12 order-xl-1">
                        <div class="card">                           
                            ...
                            <div class="col-md-12 mt-0">
                                <h3 class="mb-0">Contract Short Closer</h3>
                            ...
                            <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive"> 
                                            ...
                                            <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="BalContractQty" HeaderText="Qty" />
                                                    <asp:BoundField DataField="ContractPrice" HeaderText="Price" />
                                                    <asp:BoundField DataField="ReasonOfRejection" HeaderText="Reason Rejection" />
                                        ...
                                        <div style="margin-top: 25px" id="dvShortCloser" runat="server">
