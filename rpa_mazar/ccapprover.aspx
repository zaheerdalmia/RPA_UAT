<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ccapprover.aspx.cs" Inherits="rpa_mazar.poapprover" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CC Approver View - RPA Dalmia</title>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="requestor_email" HeaderText="SPOC" />
                                            <asp:BoundField DataField="ReqID" HeaderText="REQ ID" />
                                            <asp:BoundField DataField="ContractID" HeaderText="ContractID" />
                                            <asp:BoundField DataField="Consider" HeaderText="FLOOR PIRCE TYPE" />
                                            <asp:BoundField DataField="Designation" HeaderText="APPROVING AUTHORITY" />
                                            <asp:BoundField DataField="zone" HeaderText="ZONE" />
                                            <asp:BoundField DataField="Region" HeaderText="STATE" />
                                            <asp:BoundField DataField="AttributeKey" HeaderText="CUSTOMER CATEGORY" />
                                            <asp:BoundField DataField="Customer_Code" HeaderText="Sold-to Code" />
                                            <asp:BoundField DataField="Customer_Name" HeaderText="Sold-to Name" />
                                            <asp:BoundField DataField="Consignee_Code" HeaderText="Ship-to Code" />
                                            <asp:BoundField DataField="Payment_Terms_No_of_Days" HeaderText="PAYMENT TERMS NO OF DAYS" />
                                            <asp:BoundField DataField="qty" HeaderText="QUANTITY" />
                                            <asp:BoundField DataField="Cement_Type" HeaderText="CEMENT TYPE" />
                                            <asp:BoundField DataField="Source/Code" HeaderText="Source/Code" />
                                            <asp:BoundField DataField="EX/FOR/FPD" HeaderText="EX/FOR/FPD" />
                                            <asp:BoundField DataField="Floor_Price_Check" HeaderText="FLOOR PRICE" />
                                            <asp:BoundField DataField="Above/Below_Floor_Price" HeaderText="DEVIATION-FLOOR PRICE" />
                                            <asp:BoundField DataField="is_price" HeaderText="IS PRICE" />
                                            <asp:BoundField DataField="trade_price" HeaderText="TRADE PRICE" />
                                            <asp:BoundField DataField="diferrence" HeaderText="DEVIATION-TRADE PRICE" />
                                            <asp:BoundField DataField="is_ncr" HeaderText="IS NCR" />
                                            <asp:BoundField DataField="VC" HeaderText="VC" />
                                            <asp:BoundField DataField="Contribution_PB_if_Any" HeaderText="CONTRIBUTION" />
                                            <asp:BoundField DataField="IA_Comm" HeaderText="IA COMM" />
                                            <asp:BoundField DataField="Validity_To" HeaderText="VALIDITY END DATE" />
