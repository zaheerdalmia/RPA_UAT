<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="route-approver.aspx.cs" Inherits="rpa_mazar.RouteApprover" %>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">Route Requests - Approve / Reject</h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="STATE_PLANT" HeaderText="STATE PLANT" />
                                            <asp:BoundField DataField="SUPZONE" HeaderText="SUP ZONE" />
                                            <asp:BoundField DataField="RECEIVINGTZONE" HeaderText="RECEIVING T ZONE" />
                                            <asp:BoundField DataField="MODEOFTRANSPORT" HeaderText="MODE OF TRANSPORT" />
                                            <asp:BoundField DataField="DISTANCE" HeaderText="DISTANCE" />
                                            <asp:BoundField DataField="TRANSITTIME" HeaderText="TRANSIT TIME" />
                                            <asp:BoundField DataField="ROUTEDESCRIPTION" HeaderText="ROUTE DESCRIPTION" />
                                            <asp:BoundField DataField="ROUTEIDENTIFICATION" HeaderText="ROUTEI DENTIFICATION" />
