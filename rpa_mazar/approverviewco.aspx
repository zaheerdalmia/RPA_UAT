<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="approverviewco.aspx.cs" Inherits="rpa_mazar.approverviewco" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CL Approver View - RPA Dalmia</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">CL Requests - Approve / Reject</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList class="form-control" ID="requestids" runat="server" onclick="clearMessage();" OnSelectedIndexChanged="requestids_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                    ...
                                    <%-- <div>
                                        <table class="table align-items-center">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th scope="col" class="sort" data-sort="name">Approve/Reject</th>
                                                    <th scope="col" class="sort" data-sort="Client Name">Client Name</th>
                                                    <th scope="col" class="sort" data-sort="status">Amount</th>
                                                    <th scope="col" class="sort" data-sort="status">Col Name</th>
                                                    <th scope="col" class="sort" data-sort="status">Col Name</th>
                                                    <th scope="col" class="sort" data-sort="status">Col Name</th>
                                                    <th scope="col" class="sort" data-sort="status">Col Name</th>
                                                    <th scope="col" class="sort" data-sort="status">Col Name</th>
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="budget">ABC Industries
                                                    </td>
                                                    <td class="budget">2500000
                                                    </td>
                                                    <td class="budget">Dummy Value
                                                    </td>
                                                    <td class="budget">Dummy Value
                                                    </td>
                                                    <td class="budget">Dummy Value
