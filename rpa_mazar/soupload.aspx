<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="soupload.aspx.cs" Inherits="rpa_mazar.soupload" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div style="margin-top: 25px">
                                    <button type="button" id="btn_upload"  runat="server" onclick="javascript:this.disabled=true;" onserverclick="btn_upload_ServerClick" class="btn btn-primary btn-lg btn-block">Upload SO Input File <i class="fas fa-upload mr-2"></i></button>
                                </div>
