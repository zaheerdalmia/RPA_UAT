<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contractextension.ascx.cs" Inherits="rpa_mazar.contractextension" %>
                    ...
                    <div class="col-xl-12 order-xl-1">
                        <div class="card">                           
                            ...
                            <div class="col-md-12 mt-0">
                                <h3 class="mb-0">Contract Extension</h3>
                            ...
                            <asp:UpdatePanel ID="upd" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive"> 
                                            ...
                                            <asp:GridView ID="gv_approvallist" runat="server" CssClass="table align-items-center" RowStyle-BorderStyle="None" BorderStyle="None" BorderWidth="0"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SalesOrg" HeaderText="SALES ORG" />
                                                    <asp:BoundField DataField="ContractNo" HeaderText="Contract No" />
                                                    <asp:BoundField DataField="ContractExtendedDate" HeaderText="Contract Extended Date" />
                                                    <asp:BoundField DataField="FloorPrice" HeaderText="Floor Price" />
                                        ...
                                        <div style="margin-top: 25px" id="dvCExtension" runat="server">
