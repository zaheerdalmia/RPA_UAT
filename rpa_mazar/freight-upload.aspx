<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="freight-upload.aspx.cs" Inherits="rpa_mazar.FreightUpload" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Freight Upload - RPA Dalmia</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">Freight Upload</h3>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="custom-radio mb-3">
                                    Freight Type: <input type="radio" style="margin-left: 1em;" id="rd_primery" runat="server" name="type" onclick="clearMessage();" />
                                    <label for="rd_primery">Primary</label>
                                    <input type="radio" style="margin-left: 1em;" id="rd_secondry" runat="server" name="type" onclick="clearMessage();" />
                                    <label for="rd_secondry">Secondary</label>
                                </div>
                                 <div class="custom-radio mb-3">
                                    Freight Type Route: <input type="radio" style="margin-left: 1em;" id="rd_new" runat="server" name="Route" onclick="clearMessage();" />
                                    <label for="rd_new">New</label>
                                    <input type="radio" style="margin-left: 1em;" id="rd_revision" runat="server" name="Route" onclick="clearMessage();" />
                                    <label for="rd_revision">Revision</label>
                                </div>
                                ...
                                <div style="margin-top: 25px">
                                    <button type="button" id="btn_upload"  runat="server" onclick="javascript:this.disabled=true;" onserverclick="btn_upload_ServerClick" class="btn btn-primary btn-lg btn-block">Upload Freight Input File <i class="fas fa-upload mr-2"></i></button>
                                </div>
